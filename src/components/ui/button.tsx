  ...
  'inline-flex items-center justify-center rounded-md text-sm font-bold transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none ring-offset-background',
  {
    variants: {
      variant: {
        ...
        outline:
          'border border-pulse-green-400 hover:bg-accent hover:text-accent-foreground',
        secondary:
          'bg-secondary text-secondary-foreground hover:bg-secondary/80',
        ghost: 'hover:bg-accent hover:text-accent-foreground',
        link: 'underline-offset-4 hover:underline text-pulse-green-400 hover:text-pulse-green-800',
        gradient:
          'bg-gradient-to-r from-pulse-green-400 to-pulse-green-stop-color text-pulse-green-800',
      },
      size: {
        default: 'h-auto',
        sm: 'h-9 px-3 py-2',
